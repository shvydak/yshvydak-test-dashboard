...
import {formatErrorLines, extractLineNumber, formatShortError} from '../../../utils/errorFormatter'
...
export default function ErrorsOverview({tests}: ErrorsOverviewProps) {
    ...
    const failedTests = tests.filter((test) => test.status === 'failed' && test.errorMessage)
        ...
        return (
            <div className="card">
                <div className="card-header">
                    ...
                    <p className="card-description">Test failures and error details</p>
                </div>
                <div className="card-content">
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                        <div className="text-4xl mb-4">🎉</div>
                        <p>No failed tests found!</p>
                        <p className="text-sm mt-2">All tests are passing successfully.</p>
                    </div>
                </div>
            </div>
        )
        ...
        <div className="card">
            <div className="card-header">
                ...
                <p className="card-description">
                    ...
                    {failedTests.length !== 1 ? 's' : ''} failed with errors
                </p>
            </div>
            <div className="card-content">
                            ...
                            <div className="bg-white dark:bg-gray-900 rounded-md border border-gray-200 dark:border-gray-600 overflow-hidden">
                                ...
                                <div className="p-3 max-h-64 overflow-y-auto">
                                    <div className="space-y-1">
                                        {formatErrorLines(error.stackTrace || error.errorMessage)}
                                    </div>
                                </div>
                            </div>
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        navigator.clipboard.writeText(
                                            error.stackTrace || error.errorMessage
                                        )
                                    }}

...
-- Note images (images attached to test notes)
CREATE TABLE IF NOT EXISTS note_images (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (test_id) REFERENCES test_notes(test_id) ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_note_images_position ON note_images(test_id, position);

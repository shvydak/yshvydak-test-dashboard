...
For detailed code optimization information, see [Code Optimization Guide](../archive/CODE_OPTIMIZATION.md).
...
- [Code Optimization Guide](../archive/CODE_OPTIMIZATION.md)
